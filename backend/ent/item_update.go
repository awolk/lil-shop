...
func (iu *ItemUpdate) SetCostCents(i int) *ItemUpdate {
	iu.mutation.ResetCostCents()
	iu.mutation.SetCostCents(i)
	return iu
}

// AddCostCents adds i to cost_cents.
func (iu *ItemUpdate) AddCostCents(i int) *ItemUpdate {
	iu.mutation.AddCostCents(i)
	return iu
}
...
func (iu *ItemUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := iu.mutation.CostCents(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
	...
	if value, ok := iu.mutation.AddedCostCents(); ok {
...
// SetCostCents sets the cost_cents field.
func (iuo *ItemUpdateOne) SetCostCents(i int) *ItemUpdateOne {
	iuo.mutation.ResetCostCents()
	iuo.mutation.SetCostCents(i)
	return iuo
}

// AddCostCents adds i to cost_cents.
func (iuo *ItemUpdateOne) AddCostCents(i int) *ItemUpdateOne {
	iuo.mutation.AddCostCents(i)
	return iuo
}
...
func (iuo *ItemUpdateOne) sqlSave(ctx context.Context) (i *Item, err error) {
	...
	if value, ok := iuo.mutation.CostCents(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: item.FieldCostCents,
	...
	if value, ok := iuo.mutation.AddedCostCents(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: item.FieldCostCents,
